...
const FullCoursePage = ({ course }) => {
  ...
  const handleCompleteCourse = async () => {
    if (!allLessonsCompleted) {
      toast.error(
        "Please complete all lessons before generating your certificate"
      );
      return;
    }
  ...
  const handleReviewSubmit = async (data) => {
    ...
    try {
      const response = await axios.post(
        `/reviews?targetId=${courseId}&targetType=course`,
        data
      );
      if (response.data.success) {
                        ...
                        <div className="flex items-center gap-2 flex-shrink-0">
                          ...
                          <Checkbox
                            ...
                            onCheckedChange={(checked) =>
                              handleLessonComplete(i, checked)
                            }
                          />
                        </div>
                        <div className="flex-1 min-w-0">
                          <AccordionTrigger className="flex items-center gap-3 hover:no-underline p-0 text-left">
                            <div className="flex items-center gap-3 flex-1 min-w-0">
                              <img
                                src={
                                  lesson.thumbnailImage || "/placeholder.svg"
                                }
                                alt={lesson.title}
            ...
            <div className="mt-6 p-4 border-t border-gray-200">
              <div className="text-center space-y-3">
                <div className="text-sm text-gray-600">
                  Progress: {completedLessons.size} of {course.lessons.length}{" "}
                  lessons completed
                </div>
                ...
                {allLessonsCompleted && !isLastLesson && (
                  <p className="text-xs text-gray-500">
                    Navigate to the last lesson to complete the course
                  </p>
                )}
              </div>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mt-3">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <h2 className="text-xl font-semibold">
            {course.lessons[currentLessonIndex]?.title}
          </h2>
                  ...
                  {lessonLoading ? (
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        {currentLesson.noteUrls &&
                        currentLesson.noteUrls.length > 0 ? (
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        ...
                        knowledge of calculus is required. Basic understanding
                        of algebra and functions would be helpful.
                      </p>
                    </div>
                  </div>
                </CardContent>
