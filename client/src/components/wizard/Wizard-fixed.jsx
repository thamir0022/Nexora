...
import { useWizardState } from "./hooks/use-wizard-state-fixed"
...
const Wizard = ({ open, onOpenChange, email }) => {
  ...
  const renderCurrentStep = () => {
    ...
    switch (currentStep) {
      ...
      case STEPS.WELCOME:
      case STEPS.INSTRUCTOR_WELCOME:
        return <WelcomeScreen {...commonProps} onClose={handleClose} isInstructor={currentStep === STEPS.INSTRUCTOR_WELCOME} />
      default:
        return null
    }
  }
